...
function createProjectCard(project) {
  ...
  projectCard.classList.add("project-card"); // Updated class name
...
function filterProjects() {
  ...
  const projectCards = projectsContainer.getElementsByClassName("project-card"); // Updated class name
...
$(document).ready(function(){
  var maxLength = 100;
  $("#about-description").on('input', function(){
    var textLength = $(this).text().length;
    var remainingLength = maxLength - textLength;
    if(remainingLength <= 0){
      $("#remaining-characters").text("Character limit reached.");
    } else {
      $("#remaining-characters").text(remainingLength + " characters remaining");
    }
  });
});
